...
public partial class Customer : System.Web.UI.Page
{
    ...
    protected void CheckName(object sender, EventArgs e)
    {
        ...
        {
            DataTable dt1 = new DataTable();
            dt1 = bal.checkCustomerName(txtName.Text, txtemail.Text);
            if (dt1.Rows.Count > 0)
            {
