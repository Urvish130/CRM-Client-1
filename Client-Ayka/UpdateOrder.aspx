    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="OrderRegistry.aspx">Orders</a></li>
                ...
                <asp:Label ID="gridcount" runat="server" Visible="false" Text=""></asp:Label>
                 <asp:Label ID="lblInq" runat="server" Visible="false" Text=""></asp:Label>
                   <asp:Label ID="lblquotno" runat="server" Visible="false" Text=""></asp:Label>
            </ol>
        </section>
        ...
        <section class="content">
                    ...
                    <div class="box-body" style="opacity: 1">
                        <div class="box box-primary">
                         ...
                         <div class="col-md-12">
                          ...
                          <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" ControlToValidate="Txttandc"
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group" runat="server" visible="false">
                            <label class="control-label">
                                Cover Letter<%--<span class="required">* </span>--%>
                            </label>
                            <asp:DropDownList ID="dpcoverletter" runat="server" data-placeholder="Select Cover letter" CssClass="form-control select2" TabIndex="13"></asp:DropDownList>
                    ...
                    <div class="box-body margin">
                            ...
                            <div class="box-body margin">
                                <div class="col-md-12">
                                    ...
                                    <asp:GridView ID="grddata1" runat="server" AlternatingRowStyle-BackColor="#C2D69B" AllowPaging="false" AllowSorting="false"
                                        ...
                                        CssClass="table table-striped table-bordered table-hover dataTable no-footer" CellPadding="2" OnRowDataBound="grddata1_RowDataBound1"
                                        CellSpacing="2" EditRowStyle-HorizontalAlign="Center" PageSize="5" HeaderStyle-BackColor="#3c8dbc" HeaderStyle-ForeColor="White">
                                        <AlternatingRowStyle BackColor="White" />
                                        <PagerStyle CssClass="csspager" />
                                        <EmptyDataTemplate>No Records Available</EmptyDataTemplate>
                        ...
                        <div class="row">
                            <div class="col-md-12 form-group" style="padding-top: 5px; text-align: right">
                                ...
                                <asp:LinkButton ID="btnUpdate"  OnClick="btnUpdate_Click"  ValidationGroup="quot" runat="server"  CssClass="btn btn-bitbucket btn-flat"><i class="fa fa-save"></i>&nbsp;Update</asp:LinkButton>
