<%@ Page Title="" Language="C#" MasterPageFile="~/Demo.master" AutoEventWireup="true" CodeFile="InvoiceReport.aspx.cs" Inherits="InvoiceReport" %>
     ...
     <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="QuotationRegistry.aspx">Order</a></li>
                ...
                <div class="col-md-12">
                    <rsweb:ReportViewer ID="ReportViewer1" Font-Names="Verdana" Font-Size="8pt"
                        ...
                        WaitMessageFont-Size="14pt" Height="800px" Width="745px" runat="server">
                         <LocalReport ReportPath="Report\InvoiceReport.rdlc">
                        </LocalReport>
                    </rsweb:ReportViewer>
                </div>
            </div>
                    ...
                    <div class="box box-warning">
                        ...
                        <div class="row" style="margin-bottom: 5px;">
                            ...
                            <div class="col-md-2" style="text-align: right;">
                                <asp:Button ID="btnsendmail" runat="server" Text="Send" TabIndex="5" CssClass="btn btn-bitbucket btn-flat"  OnClick="btnsendmail_Click" ValidationGroup="vgFlpDone"  />
                            </div>
                        </div>
                    </div>
                </div>
