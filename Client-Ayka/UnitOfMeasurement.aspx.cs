...
public partial class UnitOfMeasurement : System.Web.UI.Page
{
    ...
    protected void BtnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            else
            {
               ...
               string result= bll.Saveunitofmeasurementbll(txtName.Text, lblloginid.Text, localTime, "", "", "", "", "");
    ...
    protected void BtnUpdate_Click(object sender, EventArgs e)
    {
        try
        {
            string result=bll.tbl_unitofmeasurementupdate(lblid.Text, txtName.Text);
            if(result=="-1")
            {
