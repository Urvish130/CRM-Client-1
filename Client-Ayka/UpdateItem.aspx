            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Item Master</li>
                 ...
                 <asp:Label ID="lblrole" Visible="false" runat="server" Text=""></asp:Label>
                  ...
                  <asp:Label ID="lblBOM" Visible="false" runat="server" Text=""></asp:Label>
                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="ddlgroup"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 form-group">
                                    ...
                                    <asp:TextBox ID="txtRate" TextMode="Number" CssClass="form-control" TabIndex="10" runat="server"></asp:TextBox>
                                ...
                                <div class="col-md-3 form-group">
                                    ...
                                    <asp:TextBox ID="txtGST" TextMode="Number" CssClass="form-control" TabIndex="11" runat="server"></asp:TextBox>
                                ...
                                <div class="row">
                                        ...
                                        <div class="row">
                                             <div class="col-md-4">
                                                ...
                                                <asp:DropDownList ID="ddlsubItem"  runat="server"  OnSelectedIndexChanged="ddlsubItem_SelectedIndexChanged" CssClass="form-control select2" TabIndex="1" data-placeholder="Select Sub Item"></asp:DropDownList>
                                            ...
                                            <div class="col-md-3">
                                                <label>Rate<span class="required">* </span></label>
                                                <asp:TextBox ID="txtSubrate" placeholder="Enter Rate" ReadOnly="true" TextMode="Number" CssClass="form-control" TabIndex="5" runat="server"></asp:TextBox>
                                            ...
                                            <div class="col-md-2" style="padding-top: 20px">
                                                ...
                                                <asp:Button ID="btnBOM" OnClick="btnBOM_Click" ValidationGroup="ItemSub" CssClass="btn btn-bitbucket btn-flat" Text="Add BOM" runat="server"  />
                                                 <asp:Button ID="btnBOMUpdate" OnClick="btnBOMUpdate_Click" Visible="false" ValidationGroup="ItemSub" CssClass="btn btn-bitbucket btn-flat" Text="Update BOM" runat="server"  />
                                                  <asp:LinkButton ID="LinkButton1" runat="server" TabIndex="41" OnClick="btnReset_Click" CssClass="btn btn-bitbucket bg-gray btn-flat" CausesValidation="false"><i class="fa fa-times"></i>&nbsp;Reset</asp:LinkButton>
                                            </div>
                                        </div>
                                 <div class="row">
                                     <div class="col-md-12">
                            ...
                            <div class="row">
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-2 form-group pull-right" style="text-align: right; margin-top: 5%">
                                    <asp:LinkButton ID="btnSave" OnClick="btnSave_Click" runat="server" ValidationGroup="ItemGrp" TabIndex="16" CssClass="btn btn-bitbucket btn-flat"><i class="fa fa-save"></i>&nbsp;Update</asp:LinkButton>
                                      <asp:LinkButton ID="btnDelete" runat="server" OnClientClick = "return confirm('Do you want to delete ?');" OnClick="btnDelete_Click" TabIndex="28" ValidationGroup="comgroup" CssClass="btn btn-bitbucket btn-flat"><i class="fa fa-save"></i>&nbsp;Delete</asp:LinkButton>
                                            ...
                                            <div class="box box-primary">
                                                ...
                                                <div class="box-body">
                                                    ...
                                                    <div class="form-group pull-right">
                                                        ...
                                                        <asp:LinkButton ID="LinkButton3" runat="server" OnClick="LinkButton3_Click" TabIndex="20" CssClass="btn btn-bitbucket bg-gray btn-flat" CausesValidation="false"><i class="fa fa-times"></i>&nbsp;Reset</asp:LinkButton>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
