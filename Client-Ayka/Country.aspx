                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtName" class="form-control" TabIndex="1" runat="server" placeholder="Enter Country"></asp:TextBox>
                            ...
                            <div class="form-group pull-right">
                                ...
                                <asp:LinkButton ID="btnDelete" runat="server" TabIndex="20" CssClass="btn btn-bitbucket bg-gray btn-flat" OnClick="btnReset_Click" CausesValidation="false"><i class="fa fa-times"></i>&nbsp;Reset</asp:LinkButton>
