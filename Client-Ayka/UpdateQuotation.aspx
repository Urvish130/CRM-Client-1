...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content-wrapper">
            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator22" runat="server" ControlToValidate="dpcoverletter"
                                Display="Dynamic" ErrorMessage="Please Select  Cover Letter" InitialValue="0" Text="(*) Required" ValidationGroup="quot" SetFocusOnError="true" ForeColor="Red"
                                CssClass="validate"></asp:RequiredFieldValidator>
                        </div>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator33" runat="server" ControlToValidate="txtquotfor"
                                Display="Dynamic" ErrorMessage="Please Enter  Quotation"  Text="(*) Required" ValidationGroup="quot" SetFocusOnError="true" ForeColor="Red"
                                CssClass="validate"></asp:RequiredFieldValidator>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="box box-primary">
                        <div class="row">
                            ...
                            <div class="col-md-3 form-group">
                                ...
                                <asp:TextBox ID="txtfdate" onkeydown="return false;" class="form-control" ValidationGroup="followgrp" TabIndex="28" runat="server"></asp:TextBox>
                                <asp:CalendarExtender ID="CalendarExtender1" TargetControlID="txtfdate" Format="dd/MM/yyyy" runat="server"></asp:CalendarExtender>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" ControlToValidate="txtfdate"
                                    Display="Dynamic" ErrorMessage="Please Enter Date" Text="(*) Required" ValidationGroup="followgrp" SetFocusOnError="true" ForeColor="Red"
                                    CssClass="validate"></asp:RequiredFieldValidator>
                                </div>
                            <div class="col-md-2 form-group">
                                ...
                                <div class="input-group">
                                    <asp:DropDownList ID="dpfollowuptype" runat="server" AutoPostBack="false" data-placeholder="Select Conatct Person" CssClass="form-control select2" TabIndex="29"></asp:DropDownList>
                                      <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" ControlToValidate="dpfollowuptype"
                                    Display="Dynamic" ErrorMessage="Please Select Followup" InitialValue="0" Text="(*) Required" ValidationGroup="followgrp" SetFocusOnError="true" ForeColor="Red"
                                    CssClass="validate"></asp:RequiredFieldValidator>
                                    <span class="input-group-btn">
                            ...
                            <div class="col-md-3 form-group">
                                ...
                                <div class="input-group">
                                    <asp:DropDownList ID="dpfollowstatus" runat="server" AutoPostBack="false" data-placeholder="Select Conatct Person" CssClass="form-control select2" TabIndex="30"></asp:DropDownList>
                                   <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" ControlToValidate="dpfollowstatus"
                                    Display="Dynamic" ErrorMessage="Please Select Status" InitialValue="0" Text="(*) Required" ValidationGroup="followgrp" SetFocusOnError="true" ForeColor="Red"
                                    CssClass="validate"></asp:RequiredFieldValidator>
                            ...
                            <div class="col-md-9 form-group">
                                ...
                                <asp:TextBox ID="txtfremarks" class="form-control" TabIndex="31" TextMode="MultiLine" runat="server"></asp:TextBox>
                            ...
                            <div class="col-md-2 form-group" style="margin-top: 25px; text-align: left">
                                ...
                                <asp:LinkButton ID="lbtnaddfollowup" runat="server" ValidationGroup="followgrp" OnClick="lbtnaddfollowup_Click"  CssClass="btn btn-bitbucket btn-flat"><i class="fa fa-save"></i>&nbsp;Add Followup</asp:LinkButton>
                                <asp:LinkButton ID="lbtnupdatefollowup" Visible="false" OnClick="lbtnupdatefollowup_Click" ValidationGroup="followgrp" runat="server"  CssClass="btn btn-bitbucket btn-flat"><i class="fa fa-save"></i>&nbsp;Update Followup</asp:LinkButton>
                                <asp:LinkButton ID="lbtnresetfollowup" OnClick="lbtnresetfollowup_Click" runat="server"  CssClass="btn btn-bitbucket bg-gray btn-flat" CausesValidation="false"><i class="fa fa-times"></i>&nbsp;Reset</asp:LinkButton>
                    ...
                    <div class="box-body margin">
                        ...
                        <div class="row">
                            <div class="col-md-12 form-group" style="padding-top: 5px; text-align: right">
                                <asp:LinkButton ID="btnSave" runat="server"   OnClick="btnUpdate_Click" ValidationGroup="quot"  CssClass="btn btn-bitbucket btn-flat"><i class="fa fa-save"></i>&nbsp;Update</asp:LinkButton>
     ...
     <asp:ModalPopupExtender ID="ModalPopupExtender7" runat="server" PopupControlID="pnlfollowup" TargetControlID="LinkButton5"
                                            ...
                                            <div class="box box-primary">
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator32" runat="server" ControlToValidate="txtfollowup"
