                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator8" ValidationGroup="isubgroup" runat="server" ControlToValidate="ddlgroup"
                                Display="Dynamic" ErrorMessage="Please Select State" SetFocusOnError="true" ForeColor="Red"
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtName" class="form-control" TabIndex="1" runat="server" placeholder="Enter City"></asp:TextBox>
                            ...
                            <asp:LinkButton ID="btnDelete" OnClick="btnReset_Click" runat="server" TabIndex="5" CssClass="btn btn-bitbucket bg-gray btn-flat" CausesValidation="false"><i class="fa fa-times"></i>&nbsp;Reset</asp:LinkButton>
                            </div>
                        </div>
                    </div>
                </div>
