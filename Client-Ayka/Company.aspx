        ...
        <section class="content">
                    ...
                    <section class="content-header">
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator28" runat="server" ControlToValidate="imgupload"
                                    Display="Dynamic" ErrorMessage="Please Select File" Text="(*) Required" SetFocusOnError="true" ValidationGroup="comgroup" ForeColor="Red"
                                    CssClass="validate"></asp:RequiredFieldValidator>
                                <asp:Label ID="imglbl" runat="server" Visible="false" Text=""></asp:Label>
                                <asp:Label ID="imglbl2" runat="server" Visible="false" Text=""></asp:Label>
                            </div>
                        </div>
                    </section>
                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server"
                                    ControlToValidate="txtcontactphno" ErrorMessage="Please Enter  valid Number" SetFocusOnError="true" ForeColor="Red"
                                    ValidationExpression="[0-9]{10}"></asp:RegularExpressionValidator>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server"
                                    ControlToValidate="txtcontactmno1" ErrorMessage="Please Enter  valid Number" SetFocusOnError="true" ForeColor="Red"
                                    ValidationExpression="[0-9]{10}"></asp:RegularExpressionValidator>
                            </div>
                            <div class="col-md-4 form-group">
                                <label class="control-label">
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server"
                                    ControlToValidate="txtcontactmno2" ErrorMessage="Please Enter  valid Number" SetFocusOnError="true" ForeColor="Red"
                                    ValidationExpression="[0-9]{10}"></asp:RegularExpressionValidator>
            ...
            <div class="row" style="text-align: right">
                ...
                <div class="col-md-12 form-group" style="padding-top: 5px">
                    ...
                    <asp:LinkButton ID="btnDelete" runat="server" OnClick="btnReset_Click" TabIndex="32" CssClass="btn btn-bitbucket bg-gray btn-flat" CausesValidation="false"><i class="fa fa-times"></i>&nbsp;Reset</asp:LinkButton>
                </div>
            </div>
            <!-- /.row -->
        </section>
                                            ...
                                            <div class="box box-primary">
                                                ...
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <asp:Label ID="lblmsgBussiness" runat="server" Text="" ForeColor="Red"></asp:Label>
                                                            </div>
                                                        </div>
                                                        <label class="control-label">
