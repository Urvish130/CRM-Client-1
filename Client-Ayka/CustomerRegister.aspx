        ...
        <section class="content">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="col-md-4">
                        <asp:LinkButton ID="btnfilter" runat="server" TabIndex="4" OnClick="btnfilter_Click" Style="margin-top: 25px;" CssClass="btn btn-bitbucket btn-flat"><i class="fa fa-save"></i>&nbsp;Filter</asp:LinkButton>
                        <asp:LinkButton ID="btnreset" runat="server" TabIndex="5" OnClick="btnreset_Click" Style="margin-top: 25px;" CssClass="btn btn-bitbucket bg-gray btn-flat" CausesValidation="false"><i class="fa fa-times"></i>&nbsp;Reset</asp:LinkButton>
                    </div>
                </div>
            </div>
            <div class="row">
