                            ...
                            <div class="form-group">
                               ...
                               <asp:TextBox ID="txtName" class="form-control" TabIndex="1" runat="server" placeholder="Enter Name"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtName"
                                    Display="Dynamic" ErrorMessage="Please Enter Name" ValidationGroup="desgrp" Text="(*) Required" SetFocusOnError="true" ForeColor="Red"
                                    CssClass="validate"></asp:RequiredFieldValidator>
                            </div>
                            <div class="form-group pull-right">
                                <asp:LinkButton ID="BtnSave" runat="server" TabIndex="19" OnClick="BtnSave_Click" ValidationGroup="desgrp"  CssClass="btn btn-bitbucket btn-flat" ><i class="fa fa-save"></i>&nbsp;Save</asp:LinkButton>
