...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            else
            {
               ...
               string result= bll.SaveMyTablebll(txtName.Text, lblloginid.Text, localTime, "", "", "", "", "");
                if(result=="1")
                {
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        {
            DataTable dt1 = new DataTable();
            dt1 = bll.checkupdatedata(txtName.Text,lblid.Text);
            if (dt1.Rows.Count > 0)
            {
                ShowMessage("Name Already Exist!!!", MessageType.Error);
                //lblmsg.Text = "Name Already Exist!!!";
            ...
            {
               string result= bll.tbl_update(lblid.Text, txtName.Text);
                if(result=="1")
                {
