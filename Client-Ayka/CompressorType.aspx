<%@ Page Title="" Language="C#" MasterPageFile="~/Demo.master" AutoEventWireup="true" CodeFile="CompressorType.aspx.cs" Inherits="CompressorType" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <section class="content-header">
            <h1>Compressor Type</h1>
            <ol class="breadcrumb">
                <li><a href="Default.aspx"><i class="fa fa-dashboard"></i>Home</a></li>
                <li><a href="Demo.master">Master</a></li>
                <li class="active"> Compressor Type</li>
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtCompressortype" class="form-control" TabIndex="1" runat="server" placeholder="Enter Compressor Type"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtCompressortype"
                                    Display="Dynamic" ErrorMessage="Please Enter Compressor Type" Text="(*) Required" SetFocusOnError="true" ForeColor="Red"
                            ...
                            <asp:GridView ID="grddata" runat="server" AlternatingRowStyle-BackColor="#C2D69B" AllowPaging="false" AllowSorting="false"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Name">
                                        <ItemTemplate>
                                            <asp:Label ID="lblname" runat="server" Text='<%# Eval("CompressorType") %>'></asp:Label>
                                        </ItemTemplate>
