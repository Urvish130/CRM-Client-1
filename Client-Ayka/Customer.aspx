                    ...
                    <section class="content-header">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator29" runat="server" ControlToValidate="rbtnstatus"
                                            ...
                                            <div class="box box-primary">
                                                ...
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <asp:Label ID="lblbussiness" runat="server" Text="" ForeColor="Red"></asp:Label>
                                                            </div>
                                                        </div>
                                                        <label class="control-label">
