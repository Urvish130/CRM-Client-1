                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtphno"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <asp:TextBox ID="txtdoa" onkeydown="return false;" CssClass="form-control" ClientIDMode="Static" TabIndex="18" runat="server" data-inputmask="'alias': 'dd/mm/yyyy'" placeholder="Select Date"></asp:TextBox>
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <asp:TextBox ID="txtdoj" onkeydown="return false;" CssClass="form-control" TabIndex="19" runat="server" data-inputmask="'alias': 'dd/mm/yyyy'" placeholder="Select Date"></asp:TextBox>
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <asp:TextBox ID="txtdol" onkeydown="return false;"  CssClass="form-control" TabIndex="20" runat="server" data-inputmask="'alias': 'dd/mm/yyyy'" placeholder="Select Date"></asp:TextBox>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <asp:TextBox ID="txtEmail" class="form-control" TabIndex="23" runat="server" placeholder="Enter Email" OnUnload="CheckEmployee"></asp:TextBox>
                        ...
                        <section class="content-header">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 form-group" style="margin-top: 15px; text-align: left">
                                    ...
                                    <asp:LinkButton ID="lbtnadddocument" OnClick="lbtnadddocument_Click" runat="server" TabIndex="35" CssClass="btn btn-bitbucket btn-flat"><i class="fa fa-save"></i>&nbsp;Add Document</asp:LinkButton>
