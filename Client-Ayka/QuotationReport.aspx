<%@ Page Title="" Language="C#" MasterPageFile="~/Demo.master" AutoEventWireup="true" CodeFile="QuotationReport.aspx.cs" Inherits="QuotationReport" %>
                ...
                <div class="col-md-12">
                    <rsweb:ReportViewer ID="ReportViewer1" Font-Names="Verdana" Font-Size="8pt"
                        ...
                        WaitMessageFont-Size="14pt" Height="800px" Width="745px" runat="server">
                         <LocalReport ReportPath="Report\QuotationReport.rdlc">
                        </LocalReport>
                    </rsweb:ReportViewer>
                </div>
            </div>
