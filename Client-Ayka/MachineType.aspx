<%@ Page Title="" Language="C#" MasterPageFile="~/Demo.master" AutoEventWireup="true" CodeFile="MachineType.aspx.cs" Inherits="MachineType" %>
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtmachinetype" class="form-control" TabIndex="1" runat="server" placeholder="Enter Machine Type"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtmachinetype"
                                    Display="Dynamic" ErrorMessage="Please Enter Machine Type" Text="(*) Required" SetFocusOnError="true" ForeColor="Red"
                            ...
                            <asp:GridView ID="grddata" runat="server" AlternatingRowStyle-BackColor="#C2D69B" AllowPaging="false" AllowSorting="false"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Name">
                                        <ItemTemplate>
                                            <asp:Label ID="lblname" runat="server" Text='<%# Eval("MachineType") %>'></asp:Label>
                                        </ItemTemplate>
