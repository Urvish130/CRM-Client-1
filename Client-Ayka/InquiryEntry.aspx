...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="content-wrapper">
                ...
                <div class="box-body">
                    ...
                    <div class="box box-primary" style="margin-top: 30px">
                        <div class="row" style="margin-top: 10px">
                            ...
                            <div class="col-md-2">
                                <asp:LinkButton ID="LinkButton1" OnClick="btnSave_Click" runat="server" ValidationGroup="Emst" TabIndex="51" CssClass="btn btn-bitbucket btn-flat"><i class="fa fa-save"></i>&nbsp;Save</asp:LinkButton>
        ...
        <%-- <asp:ModalPopupExtender ID="ModalPopupExtender1" runat="server" PopupControlID="pnlname" TargetControlID="lbtncust"
            CancelControlID="btnclosesname" BackgroundCssClass="modalBackground">
        </asp:ModalPopupExtender>
        <asp:Panel ID="pnlname" runat="server" CssClass="modalPopup" align="center" Style="display: none">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" id="btnclosesname" aria-label="Close">
                                        <span aria-hidden="true">&times;</span></button>
                                    <h4 class="modal-title" style="text-align: center">Create Name</h4>
                                            ...
                                            <div class="box box-primary">
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        ...
                                                        <asp:TextBox ID="TextBox3" class="form-control" TabIndex="1" runat="server"></asp:TextBox>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" ControlToValidate="TextBox3"
                                                            Display="Dynamic" ErrorMessage="Please Enter Name " ValidationGroup="cnsgrp" Text="(*) Required" SetFocusOnError="true" ForeColor="Red"
                                                            CssClass="validate"></asp:RequiredFieldValidator>
                                                    </div>
                                                    <div class="form-group pull-right">
                                                        <asp:LinkButton ID="LinkButton3" ValidationGroup="ngrp" runat="server" TabIndex="2" CssClass="btn btn-bitbucket btn-flat"><i class="fa fa-save"></i>&nbsp;Save</asp:LinkButton>

                                                        <asp:LinkButton ID="LinkButton17" runat="server" TabIndex="3" CssClass="btn btn-bitbucket bg-gray btn-flat" CausesValidation="false"><i class="fa fa-times"></i>&nbsp;Reset</asp:LinkButton>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
