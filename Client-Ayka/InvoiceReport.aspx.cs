...
public partial class InvoiceReport : System.Web.UI.Page
{
    ...
    public void bindreport()
    {
        try
        {
            ...
            cmd = new SqlCommand("gettallorderitemdatabyno", c.getconnection());
            ...
            cmd3 = new SqlCommand("getallOrderdatabyno", c.getconnection());
            cmd3.CommandType = CommandType.StoredProcedure;
            cmd3.Parameters.Add("@Noseries", SqlDbType.VarChar).Value = Request.QueryString["Id"].ToString();
    ...
    protected void btnsendmail_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            mail.Body = "This is Computer Generated Invoice";
